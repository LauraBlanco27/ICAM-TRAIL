      ...
      body: SingleChildScrollView(
        ...
        child: Text(
          'Términos y Condiciones de Uso para la Aplicación ICAM TRAIL '
              ...
              'Todo el contenido de la Aplicación, incluyendo textos, gráficos, imágenes, software, código fuente, y la tecnología de realidad aumentada, es propiedad de WhiteTeam en colaboración del Colegio ICAM y además está protegido por las leyes de derechos de autor y propiedad intelectual.'
