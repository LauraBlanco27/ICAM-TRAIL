...
class SenderosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white, // Cambiamos el fondo a blanco
      body: Stack(
        children: [
          Positioned(
            bottom: 0, // Alineado con el margen inferior
            left: 0,
            right: 0,
            child: Container(
              height: 160,
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      // Esto añade un margen a los lados de la línea
                      height: 2,
                      width: 270,
                      color: Colors.black,
                    ),
                    SizedBox(height: 20),
                    Expanded(
                      // Este widget hace que el SingleChildScrollView se expanda al espacio disponible
                      child: SingleChildScrollView(
                        // Cuadro de texto con scroll
                        child: Padding(
                          // Un padding para darle espacio al texto respecto al contenedor
